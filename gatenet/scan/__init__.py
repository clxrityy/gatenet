...
Scanning operations are designed to be explicit and minimally invasive.

Results are returned using shared core models to ensure consistency
across the gatenet codebase.
"""
